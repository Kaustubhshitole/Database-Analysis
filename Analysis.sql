...
ClientsID VARCHAR(10), ProductID VARCHAR(10), Quantity INT, Cost DECIMAL(6,2), Date DATE,  
...
SELECT @sold_items_2020, @sold_items_2021, @sold_items_2020;


CREATE TRIGGER UpdateAudit AFTER INSERT ON Orders FOR EACH ROW INSERT INTO Audit (OrderDateTime)
